...
const Hero = () => {
  return (
    <div className="flex w-full md:h-full py-20 items-center">
      <div className="md:px-10 px-5 items-center justify-center flex flex-col md:flex-row w-full h-full">
        <div className="md:w-1/2 w-full md:h-full h-1/2 py-5 md:py-10 flex flex-col space-y-5">
          ...
          <Button variant={'outline'} className='border border-dark bg-light w-[11rem]  hover:bg-dark hover:text-light transition-all duration-300 ease-in-out items-center gap-2 rounded-xl font-semibold text-lg'>
        ...
        <Image
           ...
           width={700}
           height={700}
           className="relative max-w-full h-auto lg:w-full md:w-4/5 xl:w-full mx-auto"
         />
         <Image
         src="/frame41.png"
         alt="frame1"
       ...
       />
        ...
        <Image src={'/group74.png'} alt={'groupt74'} width={600} height={600}/>
        </div>
        </div>
      </div>
    </div>
